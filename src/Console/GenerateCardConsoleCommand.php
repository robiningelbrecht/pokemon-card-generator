...
class GenerateCardConsoleCommand extends Command
{
    ...
    public function configure()
    {
        ...
        $this
            ...
            ->addOption('subject', 'sub', InputOption::VALUE_OPTIONAL, 'The type of Pokémon to generate (e.g. monkey, dragon, etc.)');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        try {
            ...
            $subject = Name::fromOptionalString($input->getOption('subject'));
